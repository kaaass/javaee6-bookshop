...
INSERT INTO `metadata` VALUES ('ff8081816dd2e9aa016dd2e9b72e0000','test','2020-06-16 18:03:25','testVal');
...
INSERT INTO `order_item` VALUES ('2c9880837a194e9b017a19af2c1c0009',10,'2021-06-17 11:15:48',872,'2c9c80837a0e7bd5017a0f05bfac0000','202106170001','2c9e80837a12bdcf017a13bf6d2d0026'),('2c9c80837a0e7bd5017a0f1727290002',1,'2021-06-15 09:53:33',65,'2c9c80837a0e7bd5017a0f05bfac0000','202106150001','ff8081816e6aae62016e6aba99fa0003'),('2c9f80837a14a1d4017a14c9cf380008',2,'2021-06-16 12:26:48',178,'2c9f80837a14a1d4017a14c6010c0006','202106160005','2c9e80837a12bdcf017a133619c70007');
...
INSERT INTO `plugin` VALUES ('ff8081816e62ef65016e62f393590002',0,'2021-06-15 13:53:26','/scripts/plugin/test_plugin/');
...
INSERT INTO `product_storage` VALUES ('2c9e80837a12bdcf017a133619c70008',98),('2c9e80837a12bdcf017a13a37da60010',50),('2c9e80837a12bdcf017a13ac062c001d',200),('2c9e80837a12bdcf017a13b5c4aa0020',60),('2c9e80837a12bdcf017a13ba6ca00022',140),('2c9e80837a12bdcf017a13bca2490024',40),('2c9e80837a12bdcf017a13bf6d2d0027',90),('2c9e80837a12bdcf017a13c354160029',193),('ff8081816e6aae62016e6aba99fa0004',92),('ff8081816e6aae62016e6abce23c0008',145);
/*!40000 ALTER TABLE `product_storage` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `promote_strategy`
--

DROP TABLE IF EXISTS `promote_strategy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `promote_strategy` (
  `id` varchar(255) NOT NULL,
  `clazz` varchar(255) DEFAULT NULL,
  `is_enabled` tinyint(1) DEFAULT NULL,
  `promo_hint` varchar(255) DEFAULT NULL,
  `last_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `promo_name` varchar(255) DEFAULT NULL,
  `strategy_order` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `promote_strategy`
--

LOCK TABLES `promote_strategy` WRITE;
/*!40000 ALTER TABLE `promote_strategy` DISABLE KEYS */;
INSERT INTO `promote_strategy` VALUES ('ff80808172cb6d8e0172cb7ff7730006','net.kaaass.bookshop.promote.strategy.dbms.JavascriptStrategy',1,'所有商品满100元享8折优惠，最高减50元','2020-06-19 15:34:20','满100打8折最高减50',3,'{\"javascriptFile\":\"/scripts/javascript_strategy/discountMax.js\"}','HOT'),('ff8081816dd3a896016dd3acfbf20001','net.kaaass.bookshop.promote.strategy.dbms.DiscountEveryStrategy',1,'6·18哲学类全场满199减29，可以与折扣同享。','2019-10-22 19:04:11','哲学类全场满199减29',1,'{\"categoryId\":\"ff8081816e6aae62016e6abbefde0005\", \"every\":199, \"discount\":29, \"maxCount\":-1}','GREAT'),('ff8081816dd3a896016dd3acfbf20002','net.kaaass.bookshop.promote.strategy.dbms.JavascriptStrategy',0,'测试打折','2020-06-18 23:09:52','测试打折',2,'{\"javascriptFile\":\"/scripts/javascript_strategy/test.js\"}','INFO');
/*!40000 ALTER TABLE `promote_strategy` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `seller_info` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid` (`uid`),
  KEY `FK4A5DA56EFB2A3B8D` (`uid`),
  KEY `FK4A5DA56E74F77639` (`avatar`),
  CONSTRAINT `FK4A5DA56E74F77639` FOREIGN KEY (`avatar`) REFERENCES `media` (`id`),
  CONSTRAINT `FK4A5DA56EFB2A3B8D` FOREIGN KEY (`uid`) REFERENCES `user_auth` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-17 22:37:01
