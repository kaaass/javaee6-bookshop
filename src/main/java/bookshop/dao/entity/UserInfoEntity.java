...
public class UserInfoEntity implements IEntity<String> {
    ...
    public boolean equals(final Object o) {
        ...
        final UserInfoEntity other = (UserInfoEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UserInfoEntity;
    }
    ...
    public String toString() {
        return "UserInfoEntity(id=" + this.getId() + ", auth=" + this.getAuth() + ", wechat=" + this.getWechat() + ", avatar=" + this.getAvatar() + ", lastUpdateTime=" + this.getLastUpdateTime() + ")";
    }
}
